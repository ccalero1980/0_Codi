...
/* ######################################################################### */
{
    ...
    res = scalarProduct(res, 1/d6);
    f_dip[0].x += res.x*3./(4*PI*params.mass);
    f_dip[0].y += res.y*3./(4*PI*params.mass);
    f_dip[0].z += res.z*3./(4*PI*params.mass);
...
/* ######################################################################### */
{
    ...
    res = scalarProduct(res, 1./d6);
    f_dip[0].x += res.x*3./(4*PI);
    f_dip[0].y += res.y*3./(4*PI);
    f_dip[0].z += res.z*3./(4*PI);
...
/*  ************************************************************************ */
{
  ...
  for( i = 0; i < n_mon*n_fil; i++ )
      ...
      for( j = 0; j <  n_mon*n_fil; j++)
	{
	  ...
	  rijy    /= mag_ij;
	  rijz    /= mag_ij;
	  rijxbar  = rijx/mag_ijbar;
	  rijybar  = rijy/mag_ijbar;
	  rijzbar  = rijzbar/mag_ijbar;
