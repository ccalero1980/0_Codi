...
float   verlet_pt1_2filaments( vec_s *,
                    ...
                    vec_s *,
                    param_s );
float   verlet_pt1_2filaments_rotacio( vec_s *,
                    vec_s *,
                    vec_s *,
                    vec_s *,
                    param_s,
...
float   verlet_pt1_2filaments_gamma_var( vec_s *,
                    vec_s *,
                    vec_s *,
                    param_s );
...
void   verlet_pt2_2filaments_gamma_var( vec_s *,
                   vec_s *,
                   vec_s *,
                   param_s );
...
void oseen_2filaments_rotacio( vec_s *,
      vec_s *,
      vec_s *,
      param_s,
      float);
...
void blake_2filaments_rotacio( vec_s *,
      vec_s *,
      vec_s *,
      param_s,
      float);

void blake_2filaments_rotacio2( vec_s *,
      vec_s *,
      vec_s *,
      param_s,
      float,
